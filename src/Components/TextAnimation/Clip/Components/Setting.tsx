  ...
  const handleContentHtml = async () => {
    ...
    *{
    ...
    .clip-animate {
      ...
      /* animation: textclip 1.5s linear infinite !important; */
    }
    @keyframes textclip {
      to {
      ...
      <fieldset>
        ...
        <div className='flex'>
          <input
            ...
            value={textColorStart || '#000000'}
            onChange={(e) => {
              setTextColorStart(e.target.value)
            }}
          />
          <input
            type='text'
      ...
      <fieldset>
        ...
        <div className='flex'>
          <input
            type='color'
            className='h-[42px] bg-white border border-gray-300 text-gray-900 border-r-0 rounded-l-lg p-1'
            value={textColorCenter || '#000000'}
            onChange={(e) => {
              setTextColorCenter(e.target.value)
            }}
          />
          <input
            type='text'
      ...
      <fieldset>
        ...
        <div className='flex'>
          <input
            type='color'
            className='h-[42px] bg-white border border-gray-300 text-gray-900 border-r-0 rounded-l-lg p-1'
            value={textColorEnd || '#000000'}
            onChange={(e) => {
              setTextColorEnd(e.target.value)
            }}
          />
          <input
            type='text'
